...
const WORD_BANK: Record<number, { word: string; hint: string }[]> = {
  ...
  8: [
    ...
    { word: "frostbite", hint: "Winter's unfriendly handshake" },
  ...
  12: [
    ...
    { word: "clockworking", hint: "Gears having a group meeting" },
  ...
  16: [
    ...
    { word: "self-destructing", hint: "A message with a death wish" },
...
// ─── Get closest available word length ───
  ...
  try {
    ...
    const res = await fetch(CONFIG.LLM_ENDPOINT, {
      ...
      body: JSON.stringify({
        ...
        minLength: minLen,
        maxLength: maxLen,
        // Common LLM API fields — adjust to your provider
    ...
    // Try to extract word/hint from various response shapes
